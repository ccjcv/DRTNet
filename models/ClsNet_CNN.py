...
from models import resnet50_myamm
...
class Labeler(nn.Module):
    def __init__(self, num_classes, roi_size, grid_size):
        ...
        self.resnet50 = resnet50_myamm.resnet50(pretrained=True, strides=(2, 2, 2, 1))
        ...
        self.resnet50_2 = resnet50_myamm.resnet50(pretrained=True, use_amm=True, strides=(2, 2, 2, 2))
